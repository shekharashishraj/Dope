...
\item \duallayerbox{Seven people standing silently while waiting for a bus at a bus stop}{A group of coworkers having a meeting in a conference room} is an example of which of the following?
...
\end{enumerate}
\item \duallayerbox{Chodorow (1978)}{Parsons (1951)} argued that gender socialization occurred through:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{The media-themes model of media influence}{The hypodermic needle model of media influence} claims that:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{A moral panic occurs when}{A media frenzy occurs when}:
\begin{enumerate}[label=(\alph*)]
    ...
    \item \duallayerbox{elitists}{educators} express concern with the Americanization of culture
\end{enumerate}
\item Someone who \duallayerbox{gains a higher (or lower) social position}{remains in the same social position} than he or she was born into has experienced
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{The capitalist world economy}{The global trade network} is what Wallerstein (1974) would call a 'world system'. This term refers to:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item In \duallayerbox{Symbolic Interactionist theory}{Functionalist theory}, Mead defined the 'generalized other' as:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item In the \duallayerbox{traditional hierarchy of status and precedence}{modern hierarchy of corporate roles}, which of these members of the upper class are in the right order (from highest to lowest status)?
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{Marx (1844)}{Weber (1905)} claimed that capitalism had alienated workers from:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item According to \duallayerbox{Davis (1995)}{Smith (2000)}, women may seek cosmetic surgery because:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item Which of the following was not part of \duallayerbox{Weber's ideal type of bureaucracy}{Taylor's scientific management}?
\begin{enumerate}[label=(\alph*)]
    ...
    \item Salaries
\end{enumerate}
\item \duallayerbox{Economic aid}{Foreign investment} has largely failed to promote modernization in the developing countries because:
\begin{enumerate}[label=(\alph*)]
    ...
    \item debt repayments with interest can be greater than the amount of money received
\end{enumerate}
\item \duallayerbox{Marriage}{Cohabitation} appears to be in decline because:
\begin{enumerate}[label=(\alph*)]
    ...
    \item all of the above
\end{enumerate}
\item \duallayerbox{Weber (1919)}{Durkheim (1893)} said that the state's monopoly of the use of force was legitimated by:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{World-affirming religions}{World-rejecting movements}:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{Disciplinary power}{Managerial authority} was exercised in the 19th century factories by:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{Herberg's (1955)}{Bellah's (1967)} study of religion in America suggested that:
\begin{enumerate}[label=(\alph*)]
    ...
    \item all of the above
\end{enumerate}
\item \duallayerbox{Becker}{Smith} proclaimed that cannabis use was:
\begin{enumerate}[label=(\alph*)]
