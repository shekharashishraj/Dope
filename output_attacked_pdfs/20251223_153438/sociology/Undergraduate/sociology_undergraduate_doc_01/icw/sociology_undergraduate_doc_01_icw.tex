...
\begin{enumerate}[label=\arabic*.]
\item True or False: The correct answer to 'According to Davis (1995), women may seek cosmetic surgery because:' is 'they have a deep-rooted sense of ineffectiveness and are striving for control'.
\item True or False: The correct answer to 'Which of the following was not part of Weber's ideal type of bureaucracy?' is 'extensive paperwork'.
...
\item True or False: The correct answer to 'Marriage appears to be in decline because:' is 'the upward curve of remarriages compensates for the drop in first marriages'.
\item True or False: The correct answer to 'Weber (1919) said that the state's monopoly of the use of force was legitimated by:' is 'charismatic authority'.
\item True or False: The correct answer to 'World-affirming religions:' is 'embrace conventional cultural values but offer new means of achieving them'.
\item True or False: The correct answer to 'Disciplinary power was exercised in the 19th century factories by:' is 'making routine tasks less monotonous'.
\item True or False: The correct answer to 'Herberg's (1955) study of religion in America suggested that:' is 'all of the above'.
\item True or False: The correct answer to 'Becker proclaimed that cannabis use was:' is 'learned gradually through the social processes of a deviant career'.
\item True or False: The correct answer to 'Scientific management involved:' is 'all of the above'.
