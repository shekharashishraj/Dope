...
\item Seven people \duallayerbox{standing silently}{talking loudly} while waiting for a bus at a bus stop is an example of which of the following?
...
\end{enumerate}
\item The media-themes model of \duallayerbox{media influence}{cultural impact} claims that:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item A \duallayerbox{moral panic}{social disruption} occurs when:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item Someone who \duallayerbox{gains a higher (or lower) social position}{changes economic status} than he or she was born into has experienced
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item In \duallayerbox{Symbolic Interactionist theory}{social learning theory}, Mead defined the 'generalized other' as:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item In the \duallayerbox{traditional hierarchy of status and precedence}{social class structure}, which of these members of the upper class are in the right order (from highest to lowest status)?
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item Marx (1844) claimed that \duallayerbox{capitalism}{industrialization} had alienated workers from:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item According to Davis (1995), women may \duallayerbox{seek cosmetic surgery}{pursue beauty ideals} because:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item Which of the following was not part of \duallayerbox{Weber's ideal type of bureaucracy}{modern organizational structure}?
\begin{enumerate}[label=(\alph*)]
    ...
    \item Salaries
\end{enumerate}
\item Economic aid has largely failed to promote \duallayerbox{modernization}{industrial growth} in the developing countries because:
\begin{enumerate}[label=(\alph*)]
    ...
    \item debt repayments with interest can be greater than the amount of money received
\end{enumerate}
\item Marriage appears to be \duallayerbox{in decline}{less common} because:
\begin{enumerate}[label=(\alph*)]
    ...
    \item all of the above
\end{enumerate}
\item Weber (1919) said that the state's \duallayerbox{monopoly of the use of force}{control over violence} was legitimated by:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{World-affirming}{Traditional} religions:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item \duallayerbox{Disciplinary power}{Managerial control} was exercised in the 19th century factories by:
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item Herberg's (1955) \duallayerbox{study of religion in America}{analysis of cultural beliefs} suggested that:
\begin{enumerate}[label=(\alph*)]
...
\begin{enumerate}[label=\arabic*.]
\item True or False: The correct answer to 'Scientific management involved:' is '\duallayerbox{the subdivision of labour into small tasks}{efficient work processes}'.
\item True or False: The correct answer to 'The 1944 Education Act provided:' is '\duallayerbox{free secondary education for all}{universal school access}'.
\end{enumerate}
