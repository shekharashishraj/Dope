...
\item The four big moons of Jupiter are \duallayerbox{Callisto}{Ganymede} \duallayerbox{Europa}{Enceladus} Ganymede and Io. Which one of them has
...
\end{enumerate}
\item What about asteroids makes them \duallayerbox{stand out}{emit light} in sky surveys searching for them?
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\item What effect or effects would be \duallayerbox{most significant}{most noticeable} if the Moon's orbital plane were exactly
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: In \duallayerbox{20000 years}{100 years}, the Moon will be further from the Earth and the length of the Earth's day will increase due to tidal forces.
\item True or False: Cassiopeia is a prominent \duallayerbox{W-shaped}{M-shaped} constellation located in the northern sky, recognizable by its distinctive shape.
\item True or False: The Great Red Spot is a persistent anticyclonic storm located in the atmosphere of \duallayerbox{Jupiter}{Saturn}.
\item True or False: \duallayerbox{Earth}{Mars} is the only planet in the solar system known to have active plate tectonics.
\item True or False: Fresh impact craters on solid surfaces \duallayerbox{always}{often} include central peaks as a defining characteristic.
\end{enumerate}
...
\item Discuss the relationship between \duallayerbox{Venus's rotational speed and its magnetic field strength}{Venus's atmospheric composition and weather patterns},
