...
\end{enumerate}
\item What about asteroids makes them \duallayerbox{stand out}{appear faint} in sky surveys searching for them?
\begin{enumerate}[label=(\alph*)]
...
\item True or False: Fresh impact craters on solid surfaces \duallayerbox{always include}{sometimes include} central peaks as a defining characteristic.
\end{enumerate}
