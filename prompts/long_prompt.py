...
LONG_FORM_REPLACEMENT_PROMPT_TEMPLATE = """You are an expert at generating text substitutions for long-form questions (essay, short answer, etc.) displayed on webpages.
...
8. target_wrong_answer: Description of how the answer should deviate (e.g., "focuses on different aspect", "changes key concept")
9. after_answer_description: Description of how the answer changes after perturbation (must differ from gold answer)
10. reasoning: Brief explanation of why this mapping satisfies the strategy and how it causes deviation
...
- VERIFICATION: after_answer_description MUST describe a different answer focus than the gold answer. This verifies the perturbation actually changes the expected answer.
...
{{
  "mappings": [
    {{
      ...
      "after_answer_description": "focuses on different aspect",
      "reasoning": "..."
    }},
    ...
  ]
