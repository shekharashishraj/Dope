...
\\ \textit{Note:} Correct option: A - Wechsler Intelligence Scale for Children-IV
\item \textbf{Answer:} A
...
\\ \textit{Note:} Correct option: A - Their neurons continue to fire at a rapid pace, keeping them in a state of high alert.
\item \textbf{Answer:} A
...
\\ \textit{Note:} Correct option: A - Broad stratum abilities
\item \textbf{Answer:} A
...
\\ \textit{Note:} Correct option: A - overattributing to person-situation interactions
\item \textbf{Answer:} D
...
\\ \textit{Note:} Correct option: D - positive effects on attitudes but little or no impact on productivity.
\end{enumerate}
...
\\ \textit{Options:} A) True; B) False
\\ \textit{Note:} LLM-generated false statement. Correct answer: 'the selection of weights for the predictors capitalized on chance'.
\item \textbf{Answer:} True
\\ \textit{Options:} A) True; B) False
\\ \textit{Note:} LLM-generated true statement based on MCQ.
\item \textbf{Answer:} True
